			...
			<el-row :gutter="10">
				<el-col :span="4">
					<el-form-item label="订舱号" class="grid-content" prop="booking_no">
						<el-input size="mini" v-model="detail.booking_no" placeholder="" :disabled="edit"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="4">
				...
				<el-col :span="4">
					<el-form-item label="申请重量" class="grid-content" prop="apply_weight">
						<el-input size="mini" v-model="detail.apply_weight" placeholder=""></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="4">
					<el-form-item label="申请体积" class="grid-content" prop="apply_volume">
						<el-input size="mini" v-model="detail.apply_volume" placeholder=""></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="4">
					<el-form-item label="箱板数" class="grid-content" prop="number_plate">
						<el-input size="mini" v-model="detail.number_plate" placeholder=""></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="4">
...
export default {
  props: ["detail", "visible", "title","dataUnit"],
  data() {
    return {
      products: "",
      destinations: "",
