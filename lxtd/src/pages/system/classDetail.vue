<template>
<!-- 雷云朵 -->
	<el-dialog title="设置" class="" :visible.sync="visible" append-to-body width="65%" :before-close="close">
...
<script>
import { getEmplAuthByUserid, saveEmplAuth } from "../../service"
export default {
  ...
  methods: {
    ...
    getCheckedId() {
      ...
      saveEmplAuth({ auth_list_id: auth_list, user_id: this.detail.id }).then(res => {
